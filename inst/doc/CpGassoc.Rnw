...
coefficients & & A data frame consisting of the residual degrees of freedom, the intercept effect adjusted for possible covariates in the model, the estimated effect size, and the standard error. This item will only be returned if indep is continuous. The degrees of freedom is used in \hyperlink{class.cpg}{plot.cpg} to compute the expected t-statistics. If indep is a categorical variable this object will be \Rfunction{NULL}. \\\\

\end{longtable}

\subsection*{\small Authors}
Barfield, R.; Conneely, K.; Kilaru,V.\\
Maintainer: R. Barfield: \href{mailto:richard.thomas.barfield@emory.edu}{richard.thomas.barfield@emory.edu}\\
...
coefficients & & A data frame consisting of the residual degrees of freedom, the intercept effect adjusted for possible covariates in the model, the estimated effect size, and the standard error. This item will only be returned if indep is continuous. The degrees of freedom is used in \hyperlink{class.cpg}{plot.cpg} to compute the estimated t-statistics. If indep is a categorical variable this object will be \texttt{NULL}.\\\\
...
plot.cpg(x, save.plot = NULL, file.type="pdf", popup.pdf = FALSE, tplot = FALSE, classic = TRUE, main.title = NULL, eps.size = c(5, 5), \dots)\\
